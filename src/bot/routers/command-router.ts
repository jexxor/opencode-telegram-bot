...
import { workingCommand } from "../commands/working-command.js";
import { loopCommand } from "../commands/loop-command.js";
import { loopsCommand } from "../commands/loops-command.js";
import { missionCommand, missionsCommand } from "../commands/mission-command.js";
...
export function registerCommandRouter(bot: Bot<Context>, deps: CommandRouterDeps): void {
  ...
  bot.command("working", workingCommand);
  ...
  bot.command("loops", loopsCommand);
