...
const COMMAND_DEFINITIONS: BotCommandI18nDefinition[] = [
  ...
  { command: "working", descriptionKey: "cmd.description.working" },
  ...
  { command: "loop", descriptionKey: "cmd.description.loop" },
  { command: "loops", descriptionKey: "cmd.description.loops" },
  { command: "mission", descriptionKey: "cmd.description.mission" },
  { command: "missions", descriptionKey: "cmd.description.missions" },
