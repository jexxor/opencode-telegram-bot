...
export const ru: I18nDictionary = {
  ...
  "cmd.description.working": "Активные сессии",
  ...
  "status.session_status.working": "⏳ Работа",
  "status.session_status.access": "🔐 Доступ",
  "status.session_status.finished": "✅ Готово",
  "status.sessions.header": "Активность сессий:",
  ...
  "bot.prompt_queued": "⏳ Задача добавлена в очередь для {session} (позиция {position}).",
  "bot.prompt_queue_started": "▶️ Запущена задача из очереди в {session}",
  "working.header": "Активные сессии:",
  "working.line": "{status} | {title} | Проект: {project}",
  "working.empty": "ℹ️ Нет работающих сессий или запросов доступа.",
  "working.error": "🔴 Не удалось загрузить активные сессии.",
  "ls.file.back": "⬅️ Назад",
  "cmd.description.loop": "Создать цикл агентов",
  "cmd.description.loops": "Управлять циклами агентов",
  "loop.select": "Выберите сессии в порядке запуска. Сессии можно повторять.",
  "loop.selected.empty": "Сессии пока не выбраны.",
  "loop.selected.required": "Выберите хотя бы одну сессию.",
  "loop.button.undo": "↩️ Отменить выбор",
  "loop.button.ok": "✅ OK",
  "loop.interval": "Отправьте интервал в целых минутах (минимум 1).",
  "loop.interval.invalid": "⚠️ Интервал должен быть положительным целым числом.",
  "loop.timeout": "Отправьте время работы цикла в целых минутах или 0 без ограничения.",
  "loop.timeout.invalid": "⚠️ Время работы должно быть нулём или положительным целым числом минут.",
  "loop.prompt": "Отправьте общий промпт для всех сессий.",
  "loop.prompt.invalid": "⚠️ Общий промпт не может быть пустым.",
  "loop.created":
    "✅ Цикл создан: {count} шагов, интервал {interval} мин. Первый шаг запускается сейчас.",
  "loops.empty": "📭 Циклов агентов пока нет.",
  "loops.select": "Выберите цикл агентов:",
  "loops.details":
    "🔁 Цикл агентов\n\nСтатус: {status}\nПоследовательность: {sequence}\nИнтервал: {interval} мин\nВремя работы: {timeout} мин\nПолных циклов: {completedCycles}\nПрошло: {elapsedMinutes} мин\nПромпт: {prompt}\nСледующий запуск: {nextRunAt}\nОстановка в: {expiresAt}\nПричина остановки: {stopReason}",
  "loops.button.run": "▶️ Запустить",
  "loops.button.stop": "⏹ Остановить",
  "loops.button.delete": "🗑 Удалить",
  "loops.button.back": "⬅️ Назад",
  "loops.deleted": "Удалено",
  "cmd.description.mission": "Создать миссию",
  "cmd.description.missions": "Управлять миссиями",
  "mission.name": "🎯 Отправьте название миссии.",
  "mission.name.invalid": "Название миссии должно быть не длиннее 100 символов.",
  "mission.description": "📝 Отправьте описание миссии или - без описания.",
  "mission.description.invalid": "Описание миссии должно быть не длиннее 2000 символов.",
  "mission.sub_missions":
    "🧩 Выберите подмиссии. Повторы разрешены. Сначала вместе стартуют листья, затем выполнение по уровням поднимается к корневой миссии.",
  "mission.root_projects":
    "📁 Выберите проект, затем корневых агентов. Можно добавить агентов из нескольких проектов или оставить миссию организационной.",
  "mission.root_sessions":
    "🤖 Выберите корневых агентов. Каждый получит общее задание и сам решит, создавать ли дочерних агентов.",
  "mission.selected_sub.empty": "ℹ️ Подмиссии не выбраны.",
  "mission.selected_roots.empty": "ℹ️ Корневые агенты не выбраны.",
  "mission.button.undo": "↩️ Отменить выбор",
  "mission.button.choose_roots": "🤖 Выбрать агентов",
  "mission.button.projects": "📁 Проекты",
  "mission.button.save": "💾 Сохранить миссию",
  "mission.button.save_now": "💾 Сохранить сейчас",
  "mission.button.save_without_roots": "💾 Сохранить без агентов",
  "mission.button.select_directory": "📂 Использовать эту папку",
  "mission.cycle_forbidden": "Эта подмиссия создаст цикл миссий.",
  "mission.edit_locked": "Структуру миссии нельзя менять во время выполнения или паузы.",
  "mission.create_sessions.select_directory": "📂 Выберите папку для новых корневых агентов.",
  "mission.create_sessions.count":
    "Выбрана папка: {directory}\n\nОтправьте число создаваемых корневых сессий или 0 для одной сессии по умолчанию.",
  "mission.create_sessions.count_invalid":
    "Число сессий должно быть нулём или положительным целым числом.",
  "mission.create_sessions.success":
    "Создано и привязано корневых сессий: {count}. Папка: {directory}.",
  "mission.create_sessions.partial":
    "Создано и привязано {created} из {requested} корневых сессий. Затем создание завершилось ошибкой.",
  "mission.create_sessions.error": "Не удалось создать корневые сессии.",
  "mission.created": "✅ Миссия создана.",
  "mission.run_timeout": "⏱ Отправьте таймаут в целых минутах или 0 без таймаута.",
  "mission.run_timeout.invalid": "Таймаут должен быть нулём или положительным целым числом минут.",
  "mission.run_count": "🔁 Отправьте число полных прогонов или 0 для одного прогона.",
  "mission.run_count.invalid": "Число прогонов должно быть нулём или положительным целым числом.",
  "mission.run_prompt": "💬 Отправьте общее задание для всех агентов миссии.",
  "mission.started": "🚀 Миссия запущена.",
  "mission.updated": "✅ Миссия обновлена.",
  "mission.permission_relaunched":
    '🔴 Агент "{agent}" запросил доступ к внешнему каталогу. Запрос отклонён, сессия перезапущена со строгой инструкцией прочитать ROLE.md (попытка {retry}/{limit}).',
  "mission.permission_agent_dropped":
    '🔴 Агент "{agent}" снова запросил внешний доступ. Запрос отклонён, лимит повторов {limit} исчерпан. Этот агент отключён; остальная миссия продолжает работу.',
  "mission.session_failed":
    '🔴 Ошибка агента "{agent}": {error}. Эта сессия остановлена; остальная миссия продолжает работу.',
  "mission.edit_name": "✏️ Отправьте новое название миссии.",
  "mission.edit_description": "📝 Отправьте новое описание миссии или - без описания.",
  "mission.timeout.none": "без ограничения",
  "mission.timeout.minutes": "{minutes} мин",
  "mission.status.idle": "⚪ не запускалась",
  "mission.status.running": "🚀 выполняется",
  "mission.status.paused": "⏸️ на паузе",
  "mission.status.stopped": "⏹️ остановлена",
  "mission.status.completed": "✅ завершена",
  "mission.status.failed": "❌ ошибка",
  "missions.empty": "📭 Миссий пока нет.",
  "missions.select": "🎯 Выберите миссию:\n\n(N|M): 🧩 подмиссии | 🤖 корневые агенты",
  "missions.details":
    "🎯 Миссия: {name}\n\n📝 Описание: {description}\n📊 Статус: {status}\n🧩 Подмиссии: {subMissions}\n🌳 Корневые агенты: {roots}\n🤖 Все агенты: {agents} · ⏳ {workingAgents} · 🔐 {accessAgents} · ✅ {doneAgents}\n\n🔁 Прогоны: {completedRuns}/{requestedRuns}\n▶️ Запуски агентов: {sessionRuns}\n⚠️ Ошибки агентов: {failedRuns}\n⏱ Таймаут: {timeout}\n🕒 Начало: {startedAt}\n🏁 Завершение: {finishedAt}\n❗ Последняя ошибка: {error}",
  "missions.button.run": "🚀 Запустить",
  "missions.button.pause": "⏸️ Пауза",
  "missions.button.resume": "▶️ Продолжить",
  "missions.button.stop": "⏹️ Остановить",
  "missions.button.rename": "✏️ Название",
  "missions.button.description": "📝 Описание",
  "missions.button.sub_missions": "🧩 Подмиссии",
  "missions.button.root_sessions": "🤖 Корневые агенты",
  "missions.button.create_sessions": "➕ Создать агентов",
  "missions.button.delete": "🗑 Удалить",
  "missions.button.delete_confirm": "⚠️ Да, удалить",
  "missions.button.refresh": "🔄 Обновить",
  "missions.button.back": "⬅️ Назад",
  "missions.not_found": "Миссия больше не существует.",
  "missions.delete_warning":
    "⚠️ Удалить миссию? Она также будет удалена из следующих надмиссий: {parents}",
  "missions.delete_no_parents": "нет",
};
