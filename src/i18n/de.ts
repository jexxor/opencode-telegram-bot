...
export const de: I18nDictionary = {
  ...
  "cmd.description.working": "Aktive Sitzungen anzeigen",
  ...
  "bot.prompt_queued": "⏳ Aufgabe für {session} eingereiht (Position {position}).",
  "bot.prompt_queue_started": "▶️ Eingereihte Aufgabe in {session} gestartet",
  ...
  "status.session_status.working": "⏳ Arbeit",
  "status.session_status.access": "🔐 Zugriff",
  "status.session_status.finished": "✅ Fertig",
  "status.sessions.header": "Sitzungsaktivität:",
  "status.sessions.line": "{status} | {title}",
  "status.server_unavailable":
    "🔴 OpenCode-Server ist nicht verfügbar\n\nNutze /opencode_start, um den Server zu starten.",
  "working.header": "Aktive Sitzungen:",
  "working.line": "{status} | {title} | Projekt: {project}",
  "working.empty": "ℹ️ Keine Sitzung arbeitet oder wartet auf Zugriff.",
  "working.error": "🔴 Aktive Sitzungen konnten nicht geladen werden.",
  ...
  "cmd.description.loop": "Agentenschleife erstellen",
  "cmd.description.loops": "Agentenschleifen verwalten",
  "loop.select": "Wähle Sitzungen in Ausführungsreihenfolge. Mehrfachauswahl ist erlaubt.",
  "loop.selected.empty": "Noch keine Sitzungen ausgewählt.",
  "loop.selected.required": "Wähle mindestens eine Sitzung.",
  "loop.button.undo": "↩️ Rückgängig",
  "loop.button.ok": "✅ OK",
  "loop.interval": "Sende das Intervall in ganzen Minuten (mindestens 1).",
  "loop.interval.invalid": "⚠️ Das Intervall muss eine positive ganze Zahl sein.",
  "loop.timeout": "Sende das Schleifen-Zeitlimit in ganzen Minuten oder 0 für kein Zeitlimit.",
  "loop.timeout.invalid": "⚠️ Das Zeitlimit muss null oder eine positive ganze Minutenzahl sein.",
  "loop.prompt": "Sende den gemeinsamen Prompt für alle Sitzungen.",
  "loop.prompt.invalid": "⚠️ Der gemeinsame Prompt darf nicht leer sein.",
  "loop.created": "✅ Schleife mit {count} Schritten und {interval} Minuten Intervall erstellt. Erster Schritt startet jetzt.",
  "loops.empty": "📭 Noch keine Agentenschleifen.",
  "loops.select": "Wähle eine Agentenschleife:",
  "loops.details": "🔁 Agentenschleife\n\nStatus: {status}\nReihenfolge: {sequence}\nIntervall: {interval} Min.\nZeitlimit: {timeout} Min.\nVollständige Durchläufe: {completedCycles}\nLaufzeit: {elapsedMinutes} Min.\nPrompt: {prompt}\nNächster Lauf: {nextRunAt}\nEndet um: {expiresAt}\nStoppgrund: {stopReason}",
  "loops.button.run": "▶️ Starten",
  "loops.button.stop": "⏹ Stoppen",
  "loops.button.delete": "🗑 Löschen",
  "loops.button.back": "⬅️ Zurück",
  "loops.deleted": "Gelöscht",
};
