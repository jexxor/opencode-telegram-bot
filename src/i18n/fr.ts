...
export const fr: I18nDictionary = {
  ...
  "cmd.description.working": "Lister les sessions actives",
  ...
  "status.session_status.working": "⏳ Travail",
  "status.session_status.access": "🔐 Accès",
  "status.session_status.finished": "✅ Terminé",
  "status.sessions.header": "Activité des sessions :",
  "status.sessions.line": "{status} | {title}",
  ...
  "bot.prompt_queued": "⏳ Tâche mise en file pour {session} (position {position}).",
  "bot.prompt_queue_started": "▶️ Tâche en file démarrée dans {session}",
  "working.header": "Sessions actives :",
  "working.line": "{status} | {title} | Projet : {project}",
  "working.empty": "ℹ️ Aucune session ne travaille ou ne demande un accès.",
  "working.error": "🔴 Impossible de charger les sessions actives.",
  "ls.file.back": "⬅️ Retour",
  "cmd.description.loop": "Créer une boucle d'agents",
  "cmd.description.loops": "Gérer les boucles d'agents",
  "loop.select": "Sélectionnez les sessions dans l'ordre d'exécution. Les doublons sont autorisés.",
  "loop.selected.empty": "Aucune session sélectionnée.",
  "loop.selected.required": "Sélectionnez au moins une session.",
  "loop.button.undo": "↩️ Annuler",
  "loop.button.ok": "✅ OK",
  "loop.interval": "Envoyez l'intervalle en minutes entières (minimum 1).",
  "loop.interval.invalid": "⚠️ L'intervalle doit être un entier positif.",
  "loop.timeout": "Envoyez la durée limite de la boucle en minutes entières, ou 0 sans limite.",
  "loop.timeout.invalid": "⚠️ La durée limite doit être zéro ou un nombre entier positif de minutes.",
  "loop.prompt": "Envoyez le prompt partagé pour toutes les sessions.",
  "loop.prompt.invalid": "⚠️ Le prompt partagé ne peut pas être vide.",
  "loop.created": "✅ Boucle créée avec {count} étapes et un intervalle de {interval} minutes. Première étape maintenant.",
  "loops.empty": "📭 Aucune boucle d'agents.",
  "loops.select": "Sélectionnez une boucle d'agents :",
  "loops.details": "🔁 Boucle d'agents\n\nStatut : {status}\nSéquence : {sequence}\nIntervalle : {interval} min\nDurée limite : {timeout} min\nCycles complets : {completedCycles}\nTemps écoulé : {elapsedMinutes} min\nPrompt : {prompt}\nProchaine exécution : {nextRunAt}\nArrêt prévu : {expiresAt}\nMotif d'arrêt : {stopReason}",
  "loops.button.run": "▶️ Exécuter",
  "loops.button.stop": "⏹ Arrêter",
  "loops.button.delete": "🗑 Supprimer",
  "loops.button.back": "⬅️ Retour",
  "loops.deleted": "Supprimé",
};
