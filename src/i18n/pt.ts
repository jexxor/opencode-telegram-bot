...
export const pt: I18nDictionary = {
  ...
  "cmd.description.working": "Listar sessões em andamento",
  ...
  "bot.prompt_queued": "⏳ Tarefa enfileirada para {session} (posição {position}).",
  "bot.prompt_queue_started": "▶️ Tarefa enfileirada iniciada em {session}",
  ...
  "status.session_status.working": "⏳ Em andamento",
  "status.session_status.access": "🔐 Acesso",
  "status.session_status.finished": "✅ Concluída",
  "status.sessions.header": "Atividade das sessões:",
  "status.sessions.line": "{status} | {title}",
  "status.server_unavailable":
    "🔴 O OpenCode Server está indisponível\n\nUse /opencode_start para iniciar o servidor.",
  "working.header": "Sessões ativas:",
  "working.line": "{status} | {title} | Projeto: {project}",
  "working.empty": "ℹ️ Nenhuma sessão está em andamento ou solicitando acesso.",
  "working.error": "🔴 Não foi possível carregar as sessões ativas.",
  ...
  "cmd.description.loop": "Criar loop de agentes",
  "cmd.description.loops": "Gerenciar loops de agentes",
  "loop.select": "Selecione sessões na ordem de execução. Sessões podem ser repetidas.",
  "loop.selected.empty": "Nenhuma sessão selecionada.",
  "loop.selected.required": "Selecione pelo menos uma sessão.",
  "loop.button.undo": "↩️ Desfazer",
  "loop.button.ok": "✅ OK",
  "loop.interval": "Envie o intervalo em minutos inteiros (mínimo 1).",
  "loop.interval.invalid": "⚠️ O intervalo deve ser um número inteiro positivo.",
  "loop.timeout": "Envie o limite de tempo do loop em minutos inteiros ou 0 para não limitar.",
  "loop.timeout.invalid": "⚠️ O limite deve ser zero ou um número inteiro positivo de minutos.",
  "loop.prompt": "Envie o prompt compartilhado para todas as sessões.",
  "loop.prompt.invalid": "⚠️ O prompt compartilhado não pode estar vazio.",
  "loop.created": "✅ Loop criado com {count} etapas e intervalo de {interval} minutos. A primeira etapa começa agora.",
  "loops.empty": "📭 Nenhum loop de agentes.",
  "loops.select": "Selecione um loop de agentes:",
  "loops.details": "🔁 Loop de agentes\n\nStatus: {status}\nSequência: {sequence}\nIntervalo: {interval} min\nLimite: {timeout} min\nCiclos completos: {completedCycles}\nTempo decorrido: {elapsedMinutes} min\nPrompt: {prompt}\nPróxima execução: {nextRunAt}\nTermina em: {expiresAt}\nMotivo da parada: {stopReason}",
  "loops.button.run": "▶️ Executar",
  "loops.button.stop": "⏹ Parar",
  "loops.button.delete": "🗑 Excluir",
  "loops.button.back": "⬅️ Voltar",
  "loops.deleted": "Excluído",
};
