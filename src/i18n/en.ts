export const en = {
  ...
  "cmd.description.working": "List working sessions",
  ...
  "cmd.description.loop": "Create an agent loop",
  "cmd.description.loops": "Manage agent loops",
  ...
  "bot.prompt_queued": "⏳ Task queued for {session} (position {position}).",
  "bot.prompt_queue_started": "▶️ Started queued task in {session}",
  ...
  "status.session_status.working": "⏳ Working",
  "status.session_status.access": "🔐 Access",
  "status.session_status.finished": "✅ Finished",
  "status.sessions.header": "Session activity:",
  "status.sessions.line": "{status} | {title}",
  "status.server_unavailable":
    "🔴 OpenCode Server is unavailable\n\nUse /opencode_start to start the server.",
  "working.header": "Active sessions:",
  "working.line": "{status} | {title} | Project: {project}",
  "working.empty": "ℹ️ No sessions are currently working or requesting access.",
  "working.error": "🔴 Failed to load active sessions.",
  ...
  "loop.select":
    "Select sessions in execution order. You may select the same session more than once.",
  "loop.selected.empty": "No sessions selected yet.",
  "loop.selected.required": "Select at least one session.",
  "loop.button.undo": "↩️ Undo",
  "loop.button.ok": "✅ OK",
  "loop.interval": "Send cross-session interval in whole minutes (minimum 1).",
  "loop.interval.invalid": "⚠️ Interval must be a whole number of minutes greater than zero.",
  "loop.timeout": "Enter loop timeout in whole minutes, or send 0 for no timeout.",
  "loop.timeout.invalid": "⚠️ Timeout must be zero or a positive whole number of minutes.",
  "loop.prompt": "Send the shared prompt that each session should receive.",
  "loop.prompt.invalid": "⚠️ Shared prompt cannot be empty.",
  "loop.created":
    "✅ Loop created with {count} steps and {interval}-minute interval. First step starts now.",
  "loops.empty": "📭 No agent loops yet.",
  "loops.select": "Select an agent loop:",
  "loops.details":
    "🔁 Agent loop\n\nStatus: {status}\nSequence: {sequence}\nInterval: {interval} min\nTimeout: {timeout} min\nCompleted cycles: {completedCycles}\nElapsed: {elapsedMinutes} min\nPrompt: {prompt}\nNext run: {nextRunAt}\nStops at: {expiresAt}\nStop reason: {stopReason}",
  "loops.button.run": "▶️ Run",
  "loops.button.stop": "⏹ Stop",
  "loops.button.delete": "🗑 Delete",
  "loops.button.back": "⬅️ Back",
  "loops.deleted": "Deleted",
  ...
  "cmd.description.mission": "Create a mission",
  "cmd.description.missions": "Manage missions",
  "mission.name": "🎯 Send mission name.",
  "mission.name.invalid": "Mission name must contain at most 100 characters.",
  "mission.description": "📝 Send mission description, or - for no description.",
  "mission.description.invalid": "Mission description must contain at most 2000 characters.",
  "mission.sub_missions":
    "🧩 Select sub-missions. Duplicates are allowed. Leaf missions start together, then execution advances by level toward the root mission.",
  "mission.root_projects":
    "📁 Select a project, then choose root agents. You can add agents from multiple projects or keep this mission organizational.",
  "mission.root_sessions":
    "🤖 Select root agents. Each receives the shared task and decides whether to create child agents.",
  "mission.selected_sub.empty": "ℹ️ No sub-missions selected.",
  "mission.selected_roots.empty": "ℹ️ No root agents selected.",
  "mission.button.undo": "↩️ Undo",
  "mission.button.choose_roots": "🤖 Choose agents",
  "mission.button.projects": "📁 Projects",
  "mission.button.save": "💾 Save mission",
  "mission.button.save_now": "💾 Save now",
  "mission.button.save_without_roots": "💾 Save without agents",
  "mission.button.select_directory": "📂 Use this directory",
  "mission.cycle_forbidden": "This sub-mission would create a mission cycle.",
  "mission.edit_locked": "Mission structure cannot be edited while it is running or paused.",
  "mission.create_sessions.select_directory": "📂 Select a directory for the new root agents.",
  "mission.create_sessions.count":
    "Selected directory: {directory}\n\nSend the number of root sessions to create, or 0 for the default single session.",
  "mission.create_sessions.count_invalid": "Session count must be zero or a positive whole number.",
  "mission.create_sessions.success": "Created and attached {count} root session(s) in {directory}.",
  "mission.create_sessions.partial":
    "Created and attached {created} of {requested} root sessions. Creation then failed.",
  "mission.create_sessions.error": "Could not create root sessions.",
  "mission.created": "✅ Mission created.",
  "mission.run_timeout": "⏱ Send timeout in whole minutes, or 0 for no timeout.",
  "mission.run_timeout.invalid": "Timeout must be zero or a positive whole number of minutes.",
  "mission.run_count": "🔁 Send full run count, or 0 for the default single run.",
  "mission.run_count.invalid": "Run count must be zero or a positive whole number.",
  "mission.run_prompt": "💬 Send the shared task for every mission agent.",
  "mission.started": "🚀 Mission started.",
  "mission.updated": "✅ Mission updated.",
  "mission.permission_relaunched":
    '🔴 Agent "{agent}" requested external directory access. Request rejected and session relaunched with strict ROLE.md instructions (retry {retry}/{limit}).',
  "mission.permission_agent_dropped":
    '🔴 Agent "{agent}" requested external directory access again. Request rejected and retry limit {limit} reached. This agent was disabled; the rest of the mission continues.',
  "mission.session_failed":
    '🔴 Agent "{agent}" failed: {error}. This session was stopped; the rest of the mission continues.',
  "mission.edit_name": "✏️ Send new mission name.",
  "mission.edit_description": "📝 Send new mission description, or - for no description.",
  "mission.timeout.none": "unlimited",
  "mission.timeout.minutes": "{minutes} min",
  "mission.status.idle": "⚪ idle",
  "mission.status.running": "🚀 running",
  "mission.status.paused": "⏸️ paused",
  "mission.status.stopped": "⏹️ stopped",
  "mission.status.completed": "✅ completed",
  "mission.status.failed": "❌ failed",
  "missions.empty": "📭 No missions yet.",
  "missions.select": "🎯 Select a mission:\n\n(N|M): 🧩 sub-missions | 🤖 root agents",
  "missions.details":
    "🎯 Mission: {name}\n\n📝 Description: {description}\n📊 Status: {status}\n🧩 Sub-missions: {subMissions}\n🌳 Root agents: {roots}\n🤖 All agents: {agents} · ⏳ {workingAgents} · 🔐 {accessAgents} · ✅ {doneAgents}\n\n🔁 Runs: {completedRuns}/{requestedRuns}\n▶️ Agent runs: {sessionRuns}\n⚠️ Agent errors: {failedRuns}\n⏱ Timeout: {timeout}\n🕒 Started: {startedAt}\n🏁 Finished: {finishedAt}\n❗ Last error: {error}",
  "missions.button.run": "🚀 Run",
  "missions.button.pause": "⏸️ Pause",
  "missions.button.resume": "▶️ Resume",
  "missions.button.stop": "⏹️ Stop",
  "missions.button.rename": "✏️ Rename",
  "missions.button.description": "📝 Description",
  "missions.button.sub_missions": "🧩 Sub-missions",
  "missions.button.root_sessions": "🤖 Root agents",
  "missions.button.create_sessions": "➕ Create agents",
  "missions.button.delete": "🗑 Delete",
  "missions.button.delete_confirm": "⚠️ Yes, delete",
  "missions.button.refresh": "🔄 Refresh",
  "missions.button.back": "⬅️ Back",
  "missions.not_found": "Mission no longer exists.",
  "missions.delete_warning":
    "⚠️ Delete mission? It will also be removed from these parent missions: {parents}",
  "missions.delete_no_parents": "none",
} as const;
