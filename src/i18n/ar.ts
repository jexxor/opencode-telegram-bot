...
export const ar: I18nDictionary = {
  ...
  "cmd.description.working": "عرض الجلسات النشطة",
  ...
  "bot.prompt_queued": "⏳ تمت إضافة المهمة إلى قائمة {session} (الموضع {position}).",
  "bot.prompt_queue_started": "▶️ بدأت المهمة المنتظرة في {session}",
  ...
  "status.session_status.working": "⏳ عمل",
  "status.session_status.access": "🔐 وصول",
  "status.session_status.finished": "✅ مكتمل",
  "status.sessions.header": "نشاط الجلسات:",
  "status.sessions.line": "{status} | {title}",
  "status.server_unavailable": "🔴 خادم OpenCode غير متاح\n\nاستخدم /opencode_start لتشغيل الخادم.",
  "working.header": "الجلسات النشطة:",
  "working.line": "{status} | {title} | المشروع: {project}",
  "working.empty": "ℹ️ لا توجد جلسات تعمل أو تطلب الوصول حاليًا.",
  "working.error": "🔴 تعذر تحميل الجلسات النشطة.",
  ...
  "ls.file.back": "⬅️ رجوع",
  "cmd.description.loop": "إنشاء حلقة وكلاء",
  "cmd.description.loops": "إدارة حلقات الوكلاء",
  "loop.select": "اختر الجلسات بترتيب التنفيذ. يمكن تكرار الجلسة.",
  "loop.selected.empty": "لم يتم اختيار جلسات بعد.",
  "loop.selected.required": "اختر جلسة واحدة على الأقل.",
  "loop.button.undo": "↩️ تراجع",
  "loop.button.ok": "✅ موافق",
  "loop.interval": "أرسل الفاصل بالدقائق الصحيحة (الحد الأدنى 1).",
  "loop.interval.invalid": "⚠️ يجب أن يكون الفاصل عددًا صحيحًا موجبًا.",
  "loop.timeout": "أرسل مهلة الحلقة بالدقائق الصحيحة، أو 0 بدون مهلة.",
  "loop.timeout.invalid": "⚠️ يجب أن تكون المهلة صفرًا أو عددًا صحيحًا موجبًا من الدقائق.",
  "loop.prompt": "أرسل الطلب المشترك لكل الجلسات.",
  "loop.prompt.invalid": "⚠️ لا يمكن أن يكون الطلب المشترك فارغًا.",
  "loop.created": "✅ تم إنشاء الحلقة من {count} خطوات بفاصل {interval} دقيقة. تبدأ الخطوة الأولى الآن.",
  "loops.empty": "📭 لا توجد حلقات وكلاء بعد.",
  "loops.select": "اختر حلقة وكلاء:",
  "loops.details": "🔁 حلقة وكلاء\n\nالحالة: {status}\nالتسلسل: {sequence}\nالفاصل: {interval} دقيقة\nالمهلة: {timeout} دقيقة\nالدورات المكتملة: {completedCycles}\nالمدة المنقضية: {elapsedMinutes} دقيقة\nالطلب: {prompt}\nالتشغيل التالي: {nextRunAt}\nوقت التوقف: {expiresAt}\nسبب التوقف: {stopReason}",
  "loops.button.run": "▶️ تشغيل",
  "loops.button.stop": "⏹ إيقاف",
  "loops.button.delete": "🗑 حذف",
  "loops.button.back": "⬅️ رجوع",
  "loops.deleted": "تم الحذف",
};
