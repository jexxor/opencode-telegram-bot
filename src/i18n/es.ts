...
export const es: I18nDictionary = {
  ...
  "cmd.description.working": "Ver sesiones activas",
  ...
  "status.session_status.working": "⏳ Trabajando",
  "status.session_status.access": "🔐 Acceso",
  "status.session_status.finished": "✅ Finalizado",
  "status.sessions.header": "Actividad de sesiones:",
  ...
  "bot.prompt_queued": "⏳ Tarea en cola para {session} (posición {position}).",
  "bot.prompt_queue_started": "▶️ Tarea en cola iniciada en {session}",
  "working.header": "Sesiones activas:",
  "working.line": "{status} | {title} | Proyecto: {project}",
  "working.empty": "ℹ️ No hay sesiones trabajando ni solicitando acceso.",
  "working.error": "🔴 No se pudieron cargar las sesiones activas.",
  "ls.file.back": "⬅️ Volver",
  "cmd.description.loop": "Crear bucle de agentes",
  "cmd.description.loops": "Gestionar bucles de agentes",
  "loop.select": "Selecciona sesiones en orden de ejecución. Puedes repetir sesiones.",
  "loop.selected.empty": "Aún no hay sesiones seleccionadas.",
  "loop.selected.required": "Selecciona al menos una sesión.",
  "loop.button.undo": "↩️ Deshacer",
  "loop.button.ok": "✅ OK",
  "loop.interval": "Envía el intervalo en minutos enteros (mínimo 1).",
  "loop.interval.invalid": "⚠️ El intervalo debe ser un número entero positivo.",
  "loop.timeout": "Envía el tiempo límite del bucle en minutos enteros o 0 para no limitarlo.",
  "loop.timeout.invalid": "⚠️ El tiempo límite debe ser cero o un número entero positivo de minutos.",
  "loop.prompt": "Envía el prompt compartido para todas las sesiones.",
  "loop.prompt.invalid": "⚠️ El prompt compartido no puede estar vacío.",
  "loop.created": "✅ Bucle creado con {count} pasos e intervalo de {interval} minutos. El primer paso comienza ahora.",
  "loops.empty": "📭 No hay bucles de agentes.",
  "loops.select": "Selecciona un bucle de agentes:",
  "loops.details": "🔁 Bucle de agentes\n\nEstado: {status}\nSecuencia: {sequence}\nIntervalo: {interval} min\nTiempo límite: {timeout} min\nCiclos completos: {completedCycles}\nTiempo transcurrido: {elapsedMinutes} min\nPrompt: {prompt}\nPróxima ejecución: {nextRunAt}\nTermina a las: {expiresAt}\nMotivo de parada: {stopReason}",
  "loops.button.run": "▶️ Ejecutar",
  "loops.button.stop": "⏹ Detener",
  "loops.button.delete": "🗑 Eliminar",
  "loops.button.back": "⬅️ Volver",
  "loops.deleted": "Eliminado",
};
