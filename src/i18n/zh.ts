...
export const zh: I18nDictionary = {
  ...
  "cmd.description.working": "列出活动会话",
  ...
  "bot.prompt_queued": "⏳ 任务已加入 {session} 的队列（第 {position} 位）。",
  "bot.prompt_queue_started": "▶️ 已在 {session} 中启动排队任务",
  ...
  "status.session_status.working": "⏳ 工作",
  "status.session_status.access": "🔐 访问",
  "status.session_status.finished": "✅ 完成",
  "status.sessions.header": "会话活动：",
  "status.sessions.line": "{status} | {title}",
  "status.server_unavailable": "🔴 OpenCode 服务器不可用\n\n使用 /opencode_start 启动服务器。",
  "working.header": "活动会话：",
  "working.line": "{status} | {title} | 项目：{project}",
  "working.empty": "ℹ️ 当前没有工作中或请求访问的会话。",
  "working.error": "🔴 无法加载活动会话。",
  ...
  "model.providers.button": "🗂 提供商",
  "model.providers.title": "从列表中选择提供商：",
  "model.providers.empty": "⚠️ 没有已连接的提供商",
  "model.providers.error": "无法获取提供商列表",
  "model.providers.page_indicator": "第 {current}/{total} 页",
  "model.providers.prev_page": "⬅️ 上一页",
  "model.providers.next_page": "下一页 ➡️",
  "model.provider_models.title": "{provider} — 选择模型：",
  "model.provider_models.empty": "⚠️ {provider} 没有可用模型",
  ...
  "ls.file.download": "📥 下载",
  "ls.file.back": "⬅️ 返回",
  "cmd.description.loop": "创建代理循环",
  "cmd.description.loops": "管理代理循环",
  "loop.select": "按执行顺序选择会话。可以重复选择同一会话。",
  "loop.selected.empty": "尚未选择会话。",
  "loop.selected.required": "请至少选择一个会话。",
  "loop.button.undo": "↩️ 撤销",
  "loop.button.ok": "✅ 确定",
  "loop.interval": "发送会话间隔的整数分钟数（最少 1）。",
  "loop.interval.invalid": "⚠️ 间隔必须是正整数分钟。",
  "loop.timeout": "发送循环超时的整数分钟数，或发送 0 表示不设超时。",
  "loop.timeout.invalid": "⚠️ 超时必须为 0 或正整数分钟。",
  "loop.prompt": "发送所有会话共用的提示词。",
  "loop.prompt.invalid": "⚠️ 共用提示词不能为空。",
  "loop.created": "✅ 已创建包含 {count} 个步骤、间隔 {interval} 分钟的循环。第一步现在开始。",
  "loops.empty": "📭 尚无代理循环。",
  "loops.select": "选择代理循环：",
  "loops.details": "🔁 代理循环\n\n状态：{status}\n顺序：{sequence}\n间隔：{interval} 分钟\n超时：{timeout} 分钟\n完整循环：{completedCycles}\n已运行：{elapsedMinutes} 分钟\n提示词：{prompt}\n下次运行：{nextRunAt}\n停止时间：{expiresAt}\n停止原因：{stopReason}",
  "loops.button.run": "▶️ 运行",
  "loops.button.stop": "⏹ 停止",
  "loops.button.delete": "🗑 删除",
  "loops.button.back": "⬅️ 返回",
  "loops.deleted": "已删除",
};
